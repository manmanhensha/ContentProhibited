package com.bootdo.reserve_functions.sharding_jdbc分库分表.contoller;

import com.alibaba.fastjson.JSON;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.bootdo.reserve_functions.sharding_jdbc分库分表.mapper.ConfigRepository;
import com.bootdo.reserve_functions.sharding_jdbc分库分表.mapper.OrderItemRepository;
import com.bootdo.reserve_functions.sharding_jdbc分库分表.mapper.OrderRepository;
