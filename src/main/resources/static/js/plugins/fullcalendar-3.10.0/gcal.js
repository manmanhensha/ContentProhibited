...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("static/js/plugins/fullcalendar-3.10.0/fullcalendar"), require("jquery"));
	else if(typeof define === 'function' && define.amd)
		define(["static/js/plugins/fullcalendar-3.10.0/fullcalendar", "jquery"], factory);
	else if(typeof exports === 'object')
		factory(require("static/js/plugins/fullcalendar-3.10.0/fullcalendar"), require("jquery"));
	else
